...
<body>
	<div style="width: 800px; margin: 0px auto;">
		...
		<form class="form-horizontal"
			action="${pageContext.request.contextPath }/updateRecord.action"
			method="post" enctype="multipart/form-data">
			<input name="id" value="${info.id}" type="hidden" />

			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">标题名</label>
				<div class="col-sm-3">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" id="occurrenceTime"
						name="occurrenceTime"
						value="<fmt:formatDate value='${info.occurrenceTime }' pattern='yyyy-MM-dd' />" /><span>(yyyy-MM-dd)</span>
				</div>
			</div>
